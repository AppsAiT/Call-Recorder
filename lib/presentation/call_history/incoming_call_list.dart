...
class IncomingCallList extends StatefulWidget {
  final List<ContactHistory> contactList;
  final ValueChanged<ContactHistory> onClickedContact;
  IncomingCallList(this.contactList, this.onClickedContact,{super.key});


  @override
  State<IncomingCallList> createState() => _IncomingCallListState(contactList);
}

class _IncomingCallListState extends State<IncomingCallList> {
  ...
  _IncomingCallListState(this.contactList);
