...
class _AllowAccessViewState extends State<AllowAccessView> {
  ...
  List<Widget> _getSliderData(){
    return [
      _getAllowAccessDialog(context, allowBtnAction: _getContactPermission, denyButtonAction: denyButtonAction, title: AppStrings.carTitle, message: AppStrings.carMessage),
      _getAllowAccessDialog(context, allowBtnAction: _getCallLogPermission, denyButtonAction: denyButtonAction, title: AppStrings.clrTitle, message: AppStrings.clrMessage),
      _getAllowAccessDialog(context, allowBtnAction: _getMicrophonePermission, denyButtonAction: denyButtonAction, title: AppStrings.mrTitle, message: AppStrings.mrMessage),
      _getAllowAccessDialog(context, allowBtnAction: _getStoragePermission, denyButtonAction: denyButtonAction, title: AppStrings.srTitle, message: AppStrings.srMessage),
    ];
  }
  ...
  Widget _getAllowAccessDialog(BuildContext context,{required VoidCallback allowBtnAction,required VoidCallback denyButtonAction,required String title,required String message}) {
    return Padding(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                children: [
                  Checkbox(value: true, onChanged: (tee){

                  },),
                  Text(AppStrings.dant,style: TextStyle(color: ColorManager.white),)
                ],)
              ],
            ),
          ),
